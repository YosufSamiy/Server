 ...
 Main content -->
        ...
        <div class="content-wrapper">
            <div class="page-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="mb-0">     {{ trans('main_trans.Dashboard') }}
                        </h4>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <h4 class="card-text text-dark">{{ trans('sections.sections') }}</h4>
                                    <h4>{{$contsections}}</h4>
                                </div>
                            </div>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <h4 class="card-text text-dark">{{ trans('sections.Partners') }}</h4>
                                    <h4>{{$contpartner}}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">{{ trans('sections.service') }}</p>
                                    <h4>{{$contservice}}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">{{ trans('sections.messages') }}</p>
                                    <h4>{{$contmessges}}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
