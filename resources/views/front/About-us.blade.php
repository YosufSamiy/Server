...
<div class="btn-group mb-1">
    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-0228">
       <div class="container">
        <div>
            <h2 class="text-center bg-light mt-5 mb-5 p-4 text-black"> {{ trans('sections.about-us') }}
          </h2>
            <P style="font-size: 19px">{{ trans('sections.sections.AboutDis') }}</P>
        </div>

        <div>
            <h2 class="text-center bg-light mt-5 mb-5 p-4 text-black">{{ trans('sections.Vision') }} </h2>
            <P style="font-size: 19px">{{ trans('sections.VisionDis') }}</P>
        </div>

        <div class="mb-5">                                
            <h2 class="text-center bg-light mt-5 mb-5 p-4 text-black">  {{ trans('sections.functions') }}</h2>
            <P style="font-size: 19px">{{ trans('sections.functionsDis') }}</P>
        </div>
    </div>
