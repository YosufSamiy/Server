...
<li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-light-1" style="padding: 10px 20px;" href="#servics">{{ trans('sections.sections') }}</a><div class="u-nav-popup"><ul class="u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-nav-2">
@foreach ($sectio as $sectio )
  
  <li class="u-nav-item"><a  href="{{route('allServices',$sectio->id)}}" class="u-button-style u-nav-link u-white">{{$sectio->Name}}</a></li>
  @endforeach
...
<div class="btn-group mb-1">
    ...
    <div class="dropdown-menu">
      ...
      <br><br>
      <section class="u-clearfix u-section-1" id="sec-95e7">
        <div class="u-clearfix u-sheet u-sheet-1">
          <div class="u-expanded u-video"  >
            <div class="embed-responsive embed-responsive-1">
              <iframe width="100" height="300" src="https://www.youtube.com/embed/07TmoPxYokk?autoplay=1" frameborder="0" allowfullscreen></iframe>

              {{-- <iframe width="560" height="315" src="https://www.youtube.com/embed/MnSyLsIfMg8"  frameborder="0" allow="accelerometer; autoplay; " allowfullscreen></iframe> --}}
              {{-- <iframe    width="560" height="315" src="https://www.youtube.com/embed/MnSyLsIfMg8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>            </div> --}}
          </div>
        </div>
      </section>
      <br>
     <section class="u-align-center u-clearfix u-custom-color-2 u-section-2" id="carousel_8f31">
      <div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-xl u-sheet-1">
        <h1 class="u-text u-text-default u-text-palette-1-base u-text-1" id="servics"> {{ trans('sections.sections') }}</h1>
          ...
          <div class="u-repeater u-repeater-1">
            ...
            <div class="u-align-center u-container-style u-list-item u-radius-20 u-repeater-item u-shape-round u-video-cover u-white u-list-item-2">
                <div class="u-container-layout u-similar-container u-container-layout-2">
                  <img src="{{asset($sections->image_path)}}" alt="" class="u-expanded-width u-image u-image-contain u-image-default u-image-2" data-image-width="626" data-image-height="626">
                  <h4 class="u-text u-text-default u-text-palette-1-base u-text-4">  {{$sections->Name}}</h4>
                  <p class="u-text u-text-palette-1-dark-2 u-text-5">   {{$sections->Notes}}  </p>
                  <a href="{{route('allServices',$sections->id)}}" class="u-active-palette-1-light-1 u-border-2 u-border-active-white u-border-hover-white u-border-white u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-palette-1-base u-radius-50 u-text-active-white u-text-hover-white u-btn-2" target="_blank">المزيد</a>
                </div>
              </div>
      ...
      <div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-xl u-sheet-1">
        ...
        <div class="u-expanded-width u-list u-list-1">
          <div class="u-repeater u-repeater-1">
            ...
            <div class="u-align-center u-container-style u-list-item u-radius-20 u-repeater-item u-shape-round u-video-cover u-white u-list-item-2">
                <div class="u-container-layout u-similar-container u-container-layout-2">
                  <img src="{{asset($Partners->image_path)}}" alt="" class="u-expanded-width u-image u-image-contain u-image-default u-image-2" data-image-width="626" data-image-height="626">
                  <h4 class="u-text u-text-default u-text-palette-1-base u-text-4">  {{$Partners->name}}</h4>
                  <p class="u-text u-text-palette-1-dark-2 u-text-5"> {{$Partners->topic}}  </p>
                  <a href="{{$Partners->url}}" class="u-active-palette-1-light-1 u-border-2 u-border-active-white u-border-hover-white u-border-white u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-palette-1-base u-radius-50 u-text-active-white u-text-hover-white u-btn-2" target="_blank">المزيد</a>
                </div>
              </div>
    ...
    <section class="u-align-center u-clearfix u-custom-color-2 u-section-2" id="Partners">
      <div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-xl u-sheet-1">
        <h1 class="u-text u-text-default u-text-palette-1-base u-text-1" id="servics"> {{ trans('sections.Partners') }}</h1>
        <br>

    <div class="container"  >

    <img width="700px" src="{{asset('comings.jpg')}}" alt="..." class="img-thumbnail">
                ...
                <div class="u-layout-col">
                  <div class="u-align-left u-container-style u-layout-cell u-left-cell u-size-30 u-layout-cell-1">
                    <div class="u-container-layout u-container-layout-1">
                      ...
                      <p class="u-text u-text-4">info@ClickGo4.com</p>
                      <p class="u-text u-text-4">  {{ trans('sections.nubmber_egypt') }} :567385418</p>
                    </div>
                  </div>
