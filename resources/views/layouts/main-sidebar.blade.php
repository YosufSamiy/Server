        ...
        <div class="side-menu-fixed">
            <div class="scrollbar side-menu-bg">
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <!-- menu title -->
                    <li class="mt-10 mb-10 text-muted pl-4 font-medium menu-title" ><a href="{{route('Dashboard')}}">{{trans('main_trans.Dashboard')}}</a> </li>
                    <!-- menu item Elements-->
                    <li>
                        ...
                        <ul id="elements" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('Sections.index')}}">{{ trans('sections.sections') }}</a></li>
                            {{-- <li><a href="accordions.html">{{ trans('main_trans.Add_Grades') }}</a></li> --}}
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#classes-menu">
                            <div class="pull-left"><i class="fa fa-building"></i><span
                                    class="right-nav-text">{{trans('sections.service')}}</span></div>
                                    <div class="pull-right"><i class="ti-plus"></i></div>
                                    <div class="clearfix"></div>
                        </a>
                        <ul id="classes-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('Servics.index')}}">{{trans('sections.service')}} </a> </li>
                        </ul>
                    </li>
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#sections-menu">
                            <div class="pull-left"><i class="fas fa-user"></i></i><span
                                    class="right-nav-text">{{trans('sections.Partners')}}</span></div>
                                    <div class="pull-right"><i class="ti-plus"></i></div>
                                    <div class="clearfix"></div>
                        </a>
                        <ul id="sections-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('Partners.index')}}">{{trans('sections.Partners')}} </a> </li>
                        </ul>
                    </li>
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#Accounts-menu">
                            <div class="pull-left"><i class="fas fa-money-bill-wave-alt"></i><span
                                    class="right-nav-text">{{trans('sections.messages')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('Messages.index')}}">{{trans('sections.messages')}}</a> </li>
                        </ul>
                    </li>
                        @if (Auth::User()->full_options==0)
                            
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#Settings-icon">
                            <div class="pull-left"><i class="fas fa-cogs"></i><span class="right-nav-text">{{trans('sections.moderators')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="Settings-icon" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('Users.index')}}">{{trans('sections.moderators')}}</a> </li>
                        </ul>
                    </li>
                    @endif
                    ...
                    {{-- <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#classes-menu">
                            <div class="pull-left"><i class="fa fa-user"></i><span
                                    class="right-nav-text">{{trans('sections.moderators')}}</span></div>
                                    <div class="pull-right"><i class="ti-plus"></i></div>
                                    <div class="clearfix"></div>
                        </a>
                        <ul id="classes-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('Servics.index')}}">{{trans('sections.moderators')}} </a> </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul id="classes-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('Servics.index')}}">{{trans('sections.messages')}} </a> </li>
                        </ul>
                    </li> --}}
{{-- 
