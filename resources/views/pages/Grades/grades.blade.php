...
<div class="row">   
    ...
    <div class="col-xl-12 mb-30">     
      <div class="card card-statistics h-100"> 
        <div class="card-body">
            <a href="{{route('Grade.create')}}" type="button" class="btn btn-success"> <i class="fas fa-plus"></i>&nbsp;	{{ trans('Grades_trans.ADD_Grade') }}</a>
            <br>
            <br>
          ...
          <table id="datatable" class="table table-striped table-bordered p-0">
            <thead>
                <tr>
                    ...
                    <th>{{ trans('Grades_trans.Note_Grade') }}</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a type="submit" href="{{route('gard.editt',$grade->id)}}" ) class="btn btn-info btn-sm" ><i class="fa fa-edit"></i></a>
