...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0">{{ trans('sections.edit_section') }}</h4>
        </div>
        <div class="col-sm-6">
...
<div class="row">
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                <form action="{{route('Sections.update',$edit->id)}}" method="Post">
                  @csrf
                  @method('put')
                  {{-- @method('PUT') --}}
                    <!-- Name input -->
                    <div class="form-outline mb-4">
                      ...
                      <input type="text" value="{{$edit->getTranslation('Name', 'ar')}}"name="name_ar" id="name_ar" class="form-control" />
                    </div>
                  ...
                  <div class="form-outline mb-4">
                    ...
                    <div class="form-outline mb-4">
                      ...
                      <input class="form-control"  value="{{$edit->getTranslation('Notes', 'ar')}}" name="note_ar" id="note_en" rows="4"></textarea>
                    </div> 
                    <div class="form-outline mb-4">
